          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <div className="space-y-4 text-[#9aa0b0] leading-relaxed text-sm md:text-base max-w-xl">
                <p>YORIMITIは、誰もが気軽に立ち寄れる、温かな居場所を目指しています。</p>
                <p>いつものルートから少し外れてみる「よりみち」のように、私たちは決まった枠にとらわれない自由な発想を大切にしています。</p>
                <p className="text-[#e3c567] font-disp text-base md:text-lg tracking-wide py-1">「カタチも、視点も、もっと自由に。」</p>
                <p>依頼者さまの想いや作品の空気感を丁寧にくみ取り、臨機応変なアイデアと確かな技術で、これまでにない新しい視点をお届けします。「どこに頼めばいいかわからない」という不安にも寄り添い、理想の表現をともに形にしていきます。</p>
                <p>フクロウが「福を囲む鳥」と呼ばれるように、私たちに関わるすべての人とともに、たくさんの福を広げていきたい。ロゴの黒は確固たる存在と技術を、明るい背景は支えてくださる方々への感謝を象徴しています。</p>
                <p className="pt-2">ビジネスの現場でも、個人の大切な節目でも。私たちは、どんな時も心から頼れる存在であり続けます。</p>
              </div>
            </motion.div>
